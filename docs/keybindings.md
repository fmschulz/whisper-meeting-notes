...
| `Super + 1-9,0` | Jump directly to workspace 1-10 |
| `Super + Shift + ←/→` | Move focused window to previous/next workspace |
...
| `Super + Shift + W` | Cycle to previous wallpaper |
| `Super + Ctrl + W` | Apply a random wallpaper |
